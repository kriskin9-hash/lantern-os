...
($20/20$ tests passing) for the symmetric case. The other components are heuristics,
...
\item \texttt{tests/test\_cio\_sde.py} --- 20 automated tests, all passing (Theorem~1
