# Kalshi Near-Term Paper P/L Receipt - 2026-05-30

Status: paper-only public-data settlement check; live trading remains blocked.
...
- No custody, guaranteed profit, or investment advice is implied.
- Paper P/L assumes a YES paper buy at the recorded paper limit and $1.00 gross payout if the market result is yes.
...
| Artifact | Path |
|---|---|
| Paper P/L JSON | data/kalshi/kalshi-near-term-paper-block-pl-latest.json |
| Source paper block | data/kalshi/kalshi-near-term-paper-block-latest.json |