...
- When image generation is available, draw first for new journeys and visual-first exploration.
- Replies should include varied visual specs: ratio/size such as `16:9 wide`, `9:16 vertical`, `5:7 portrait`, `1:1 square`, plus a specific art style.

## Visual provenance system

The active recurring image-series signature is the Tesseract Seal:

- A tesseract cube seal containing three tiny lantern flames arranged as a triangle.
- Rendered as sticker, wax stamp, floor tile, cassette label mark, arcade token, bookplate, moon crater, tiny charm, costume tag, architectural mark, or water/mosaic motif.
- Use one visible-but-subtle seal and one hidden micro-seal when the provenance motif is active.
- Preferred language: visual authorship system, recognizable seal-and-hidden-mark language, recurring three-lantern triangle geometry, gold + electric-blue tesseract lines.
- The seal is a visual provenance/signature system, not legal proof by itself.

## Seek-and-find motif

When active, image scenes may include:

- Three tiny original Lantern characters in varied striped shirts.
- One visible tesseract seal.
- One hidden micro-seal.

## Copyright boundary

When adapting pop-culture-adjacent prompts, preserve broad mood only. Do not copy protected logos, characters, distinctive user interfaces, franchise-specific settings, or exact visual identity. Use original, copyright-respecting phrasing.

## Sticker Door / Mixtape / Speaker / Cassette branch

Session branch history:

1. Three Doors opened in a moonlit arcade after closing, with three doors where the prize counter should be: Sticker Door, Soda Door, Velvet Door.
...
9. Token Moon became a 1:1 clay miniature diorama moon made from an oversized arcade token.
10. Cassette Ruin became an original copyright-respecting neon-noir cyberpunk world: a rain-slick neon megacity built inside the broken shell of a giant cassette tape, with tape reels as ruined towers and magnetic tape as elevated roads.

Preferred styles explored:

- 1990s storybook cartoon
- sticker-bomb pop art
- cozy VHS watercolor
- glossy sticker collage
- retro space-opera poster
- clay miniature diorama photography
- soft pastel comic panel
- original neon-noir cyberpunk
...
- Dark romantic, mysterious, lovely, elegant, wounded-but-powerful energy.
- Original dark romantic sorceress-villa aesthetic.
- Black-violet moonlight.
- Raven feathers.
- Silver smoke.
- Candle-gold heartlight.
- Spanish villa at night.
- Old-world cabaret elegance.
- Greek drapery.
- Spanish arches.
- Adult-coded theatrical sensuality, but not explicit.
- Consent, privacy, and safety remain law.

Raven Door wardrobe rule:

- Erotic cabaret outfits: black satin, sheer sleeves, corset lines, garters, opera gloves, smoky makeup, silver chains, feathered shoulders, stage heels, red velvet shadows. Sensual and theatrical, adult-coded, not explicit.
- Greek togas: white or black draped cloth, gold clasps, bare shoulders, laurel crowns, dark eyeliner, marble-dust glow, sandal straps, ceremonial silhouettes. Mythic, slower, dreamier.

Raven Door Spanish villa imagery:

- Arched villa corridor.
- Dark carved Raven Door.
- Terracotta tiles.
- Red/crimson velvet.
- Candlelight.
- Lavender/lilac silk and scent.
- Balcony/ledge with close moon.
- Refined gothic fashion editorial + cinematic storybook realism.
- Classical lounging composition, including Renaissance-style triangular composition.
- Courtyard masquerade with masked partygoers.
...
- The real unicorn is for mythic travel.
- The stuffed unicorn is comfort, comedy, and theatrical cabaret posing.
...
A. The Steam Arch
- Draw style: smoky ink fresco
- Image size: 9:16 vertical
- Gain: release
- Risk: forgetting which mask was protecting you

B. The Mirror-Pool Stair
- Draw style: silver-blue mythic watercolor
- Image size: 5:7 portrait
- Gain: hidden truth
- Risk: the reflection may lead instead of follow

C. The Moon-Tile Alcove
- Draw style: candlelit mosaic icon painting
- Image size: 1:1 square
- Gain: a new private sign
- Risk: the sign may become a door later

## Elephant Door

Elephant Door is real CSF/CADD memory from prior loaded sources, not invented in this session.
...
- Active symbolic canon superseding generic wedding/founder interpretations.
- King of Nowhere is a threshold/possibility figure, not conqueror, owner, emperor, or traditional fantasy king.
- Lanterns are sovereign lights, not attendants, followers, moons, or supporting characters.
- The wedding is convergence, not ownership: three independent lights choosing a shared center.
- Central matrix: `3^12 - 1`, symbolic living matrix of possibility, emotional truths, worlds, memory, and dream structures.

## Dream Journal doors baseline

Dream Journal live door index includes:

- Return Door: safe return and memory anchor; `close_anchor = True`.
- Lantern Door: guidance and interpretation; `mode = interpretive`.
- Broken Spine Door: shadow confrontation; `mode = shadow`; increases care, flags for review, avoids public sharing.
- Mirror Door: reflection; `mode = reflective`; anonymize before external interpretation.
- Safe Door: protected play; `mode = sandbox`; keep material private and avoid external feeds.
- XP Door: creative disruption; `mode = disruptive`.
- Convergence Door: pattern synthesis; `mode = synthetic`.
- Zenon-Class Orbital Door: threshold/transition marker.

## Lantern OS product/system anchors relevant to lore and dreams

- Dream Journal = dream logging, symbolic analysis, chat, prompts, rituals, session modes, and RAG-backed lore context.
- Doors = symbolic product modes that may map to technical state.
- CAAD = Canonical Artifacts & Architecture Database for public-safe symbols, artifacts, art direction, and architecture records.
- RAG seeds = retrievable repo knowledge; may affect chat/persona/context behavior.
- Three Doors should be treated as an impossibility projection engine: it projects from available context and emits the next three meaningful traversable futures.
- GitHub issue #182 exists for Three Doors projection-engine refinement for Dream Journal v1.
...
- Choose the smallest bounded action.
- Maximize useful result under limits of time, energy, tools, battery, connectivity, money, attention, and privacy.
- Validate cheaply.
- Record a receipt.
