...
- Name: tests\test_three_doors_game.spec.js >> Three Doors Game - UI Tests >> Can click door button and navigate to new scene
- Location: tests\test_three_doors_game.spec.js:160:3
