...
function Test-ServiceHealth {
    ...
    # Deadlock note: a short timeout prevents blocking on the single-threaded
    # MCP listener. A service that cannot respond to /health quickly under the
    # supervisor poll interval is considered unhealthy regardless of TCP state.
    $httpOnline = $false
