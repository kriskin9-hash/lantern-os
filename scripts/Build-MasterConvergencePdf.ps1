param(
    ...
    [string]$Source = "reports/COMET-LEAP-TOKEN-BURN-REVENUE-CONVERGENCE-v1.md",
    [string]$Output = "artifacts/COMET-LEAP-TOKEN-BURN-REVENUE-CONVERGENCE-v1.pdf",
...
$temp = Join-Path $env:TEMP "build-lantern-convergence-pdf.py"
